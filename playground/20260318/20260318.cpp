...
int main()
{
    ...
    std::cout << "intresa la cantidad de ventas: ";
    std::cin >> cantidad_ventas;
    ejercicio1(cantidad_ventas);
...
void ejercicio1(int cantidad_ventas)
{
    ...
    for (int i = 0; i < cantidad_ventas; i++)
    {
        ...
        std::cout << "ingresa el monto de la venta: ";
        std::cin >> precio;
        ...
        {
            promedio_ventas = static_cast<double>(total_vendido) / cantidad_ventas;
        }
